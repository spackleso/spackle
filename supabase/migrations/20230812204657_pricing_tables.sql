...
alter table "public"."pricing_table_products" add constraint "pricing_table_products_annual_stripe_price_id_fkey" FOREIGN KEY (annual_stripe_price_id) REFERENCES stripe_prices(stripe_id) ON DELETE CASCADE not valid;

alter table "public"."pricing_table_products" validate constraint "pricing_table_products_annual_stripe_price_id_fkey";

alter table "public"."pricing_table_products" add constraint "pricing_table_products_monthly_stripe_price_id_fkey" FOREIGN KEY (monthly_stripe_price_id) REFERENCES stripe_prices(stripe_id) ON DELETE CASCADE not valid;
